...
use OCA\VO_Federation\Service\CommunityAAIService;
...
class ConfigController extends Controller {
	...
	private $l;
	/**
	 * @var CommunityAAIService
	 */
	private $communityAAIService;
	/**
	 * @var string|null
	 */
	private $userId;
	...
	public function __construct(string $appName,
								...
								IL10N $l,
								CommunityAAIService $communityAAIService,
								?string $userId) {
        parent::__construct($appName, $request);
		$this->config = $config;
		$this->urlGenerator = $urlGenerator;
		$this->l = $l;
		$this->communityAAIService = $communityAAIService;
		$this->userId = $userId;
	}
    ...
    public function doOauthStep1(): DataResponse {
        ...
        $requestToken = $this->communityAAIService->requestTokenOAuthStep1($consumerKey, $consumerSecret);
    ...
    public function oauthRedirect(?string $url = ''): RedirectResponse {
        ...
        $token = $this->communityAAIService->requestTokenOAuthStep3($consumerKey, $consumerSecret, $oauthToken, $oauthTokenSecret, $oauthVerifier);
...
//            $result .= ' ' . $e->getMessage();
        ...
        // get my username
        $creds = $this->communityAAIService->classicRequest(
