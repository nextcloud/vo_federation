...
return [
	'routes' => [
		...
		['name' => 'config#createProvider', 'url' => '/provider', 'verb' => 'POST'],
		['name' => 'config#updateProvider', 'url' => '/provider/{providerId}', 'verb' => 'PUT'],
		['name' => 'config#deleteProvider', 'url' => '/provider/{providerId}', 'verb' => 'DELETE'],
